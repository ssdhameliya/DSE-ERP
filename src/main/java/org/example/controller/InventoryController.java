...
public class InventoryController implements ScreenLifecycle {
 ...
 private final ItemService service=new ItemService();private final FxDebouncer searchDebouncer=new FxDebouncer(java.time.Duration.ofMillis(220));private final NumberFormat money=NumberFormat.getCurrencyInstance(new Locale("en","IN"));private List<Item>all=List.of();private Item selected;
