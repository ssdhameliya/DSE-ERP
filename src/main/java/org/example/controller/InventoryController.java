...
public class InventoryController implements ScreenLifecycle {
 ...
 private void installKpiIcons(){setKpiIcon(inventoryTotalIcon,"item");setKpiIcon(inventoryStockIcon,"complete");setKpiIcon(inventoryLowIcon,"reminder");setKpiIcon(inventoryOutIcon,"error");setKpiIcon(inventoryValueIcon,"currency");}
