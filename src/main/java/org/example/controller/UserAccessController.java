...
public class UserAccessController {
    ...
    private void loadUsers(){
        users.clear(); String sql="SELECT u.*,COALESCE(r.role_name,u.role,'SALES') resolved_role FROM users u LEFT JOIN roles r ON r.id=u.role_id ORDER BY u.full_name,u.username";
