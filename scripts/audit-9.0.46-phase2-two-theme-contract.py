#!/usr/bin/env python3
"""DSE ERP 9.0.46 Phase 2 final two-theme contract.
...
frozen by audit-9.0.46-ui-behavior-freeze.py; this contract enforces the runtime
...
# This one difference existed in the approved 9.0.46 visual baseline before
...
def main() -> int:
    ...
    # 9.0.46 consolidation: legacy Reporting / Shortcut namespaces must not remain,
