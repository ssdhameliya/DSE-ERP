...
need('<version>9.0.57</version>' in t('pom.xml') and '<dse.phase>9.0.57</dse.phase>' in t('pom.xml'),'root version')
need('APP_VERSION = "9.0.57"' in t('shared/src/main/java/org/example/shared/RuntimeContract.java'),'runtime version')
need('version=9.0.57' in t('desktop/src/main/resources/app-version.properties'),'desktop version')
need('dse.app.version=9.0.57' in t('server/src/main/resources/application.properties'),'server version')
