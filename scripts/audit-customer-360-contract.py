...
need("<version>9.0.77</version>" in t("pom.xml") and "<dse.phase>9.0.77</dse.phase>" in t("pom.xml"),"root version")
need('APP_VERSION = "9.0.77"' in t("shared/src/main/java/org/example/shared/RuntimeContract.java"),"runtime version")
