...
require('APP_VERSION = "9.0.79"' in runtime and 'BUILD_REVISION = "9.0.79"' in runtime,
        'Desktop app version and build revision must both be 9.0.79')
require('dse.app.version=9.0.79' in props and 'dse.build.revision=9.0.79' in props,
        'Spring Boot app/build version must exactly match desktop 9.0.79')
