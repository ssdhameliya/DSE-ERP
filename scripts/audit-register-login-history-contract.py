...
req('salesMetrics(where)' in business and 'private OperationDtos.SalesMetrics salesMetrics(SqlWhere where)' in business, 'Sales KPIs must use current register filters')
req('purchaseMetrics(where)' in business and 'private OperationDtos.PurchaseMetrics purchaseMetrics(SqlWhere where)' in business, 'Purchase KPIs must use current register filters')
