...
req('colHistoryBank" text="Bank / Account"' in bank_fxml and 'headerMinimum(column, heading, semantic)' in dynamic_table and ('flexWeight(semantic, heading)' in dynamic_table), 'Bank Statement History Bank/Account column must remain readable through the global dynamic table authority')
