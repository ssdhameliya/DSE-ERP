...
req('<version>9.0.74</version>' in root_pom and '<dse.phase>9.0.74</dse.phase>' in root_pom,'Maven identity must be 9.0.74')
req('version=9.0.74' in app_version and 'DEFAULT_VERSION="9.0.74"' in update,'Desktop/updater identity must be 9.0.74')
...
print('REGISTER_LOGIN_HISTORY_CONTRACT_OK version=9.0.74')
