...
req('<version>9.0.47</version>' in root_pom and '<dse.phase>9.0.47</dse.phase>' in root_pom,'Maven identity must be 9.0.18')
req('version=9.0.47' in app_version and 'DEFAULT_VERSION="9.0.47"' in update,'Desktop/updater identity must be 9.0.18')
