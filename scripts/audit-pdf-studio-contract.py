...
req('private static final int RELEASE_VERSION = 11;' in builtin_installer and '58.6688, 224.05' in builtin_installer and ('337.6388, 224.05' in builtin_installer) and ('refreshBuiltInSource' in builtin_installer) and ('multiField(e, "party.billingAddress"' in builtin_installer) and ('multiField(e, "party.deliveryAddress"' in builtin_installer) and ('field(e, "transport.name"' in builtin_installer) and ('field(e, "transport.gstin"' in builtin_installer) and ('field(e, "transport.contact"' in builtin_installer) and ('true replacement' in builtin_installer) and ('protected transport-strip top border' in builtin_installer) and ('Do not repaint the' in builtin_installer) and ('double transportY = 238.83, transportFont = 6.45;' in builtin_installer) and ('transport.contact", 460.0' in builtin_installer), 'current built-in Sales template v11 must preserve protected structural artwork while using corrected GSTIN/address geometry, sanitized source upgrade and non-overlapping source-area transport value mapping')
