#!/usr/bin/env python3
"""DSE ERP 9.0.49 corrective UI stabilization contract.
...
if 'fx:id="metricPane"' in viewer_raw or 'report-metric-strip' in viewer_raw:
    fail("Individual Report Viewer KPI strip must remain removed in 9.0.49")
...
# 9.0.49 table-first Reporting / icon+text / Bank KPI contracts.
