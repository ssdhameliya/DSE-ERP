...
req("runtime identity manifest phase must be 9.0.18" in pdf_audit and 'runtime.phase=9.0.35' in manifest,'GitHub/source runtime identity manifest must be pinned to 9.0.18')
