...
req('V9_0_16__quotation_source_navigation_hardening' in runner,'v9.0.17 migration must be registered')
...
req('APP_VERSION = "9.0.17"' in runtime and 'BUILD_REVISION = "9.0.17"' in runtime,'runtime identity must be 9.0.17')
req('dse.app.version=9.0.17' in props and 'dse.build.revision=9.0.17' in props,'server identity must be 9.0.17')
req('<version>9.0.17</version>' in pom and '<dse.phase>9.0.17</dse.phase>' in pom,'Maven identity must be 9.0.17')
req('version=9.0.17' in app and 'DEFAULT_VERSION="9.0.17"' in update,'desktop/update identity must be 9.0.17')
...
req("runtime identity manifest phase must be 9.0.17" in pdf_audit and 'runtime.phase=9.0.17' in manifest,'GitHub/source runtime identity manifest must be pinned to 9.0.17')
...
for prop in (
    ...
    req(prop in props, f'missing v9.0.17 PostgreSQL/Hikari stability setting: {prop}')
print('PASS: DSE ERP 9.0.17 Quotation Source + linked Sale + runtime stability contract')
