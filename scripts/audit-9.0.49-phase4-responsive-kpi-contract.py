#!/usr/bin/env python3
"""DSE ERP 9.0.49 Phase 4 responsive KPI layout contract."""
...
SOURCE_MAP = ROOT / "scripts/phase4-responsive-kpi-source-map-9.0.49.json"
...
def main() -> int:
    ...
    if len(containers) != 31:
        fail(f"expected 31 reviewed KPI containers, found {len(containers)}")
