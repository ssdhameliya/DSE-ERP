...
need(('LEGACY_MFA_CHALLENGE_ISSUED' in a) or ('MFA_ENROLLMENT_PROVISIONED' in a and 'LEGACY_MFA_LOGIN_SUCCESS' in a), 'existing-user MFA compatibility/enrollment bridge missing')
