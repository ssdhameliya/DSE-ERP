...
req('APP_VERSION = "9.0.34"' in runtime and 'BUILD_REVISION = "9.0.34"' in runtime,
    'desktop/server runtime identity is 9.0.34')
req('dse.app.version=9.0.34' in props and 'dse.build.revision=9.0.34' in props and 'version=9.0.34' in app,
    'server and desktop resource identity is 9.0.34')
...
req('DSE ERP 9.0.34' in release and 'Show / Hide Sidebar' in release,
    '9.0.34 release highlights document the workspace/sidebar feature')

print('PASS: DSE ERP 9.0.34 Sidebar workspace + shortcut contract')
