...
req('V9_0_16__quotation_source_navigation_hardening' in runner,'v9.0.57 migration must be registered')
...
req("runtime identity manifest phase must be 9.0.57" in pdf_audit and 'runtime.phase=9.0.57' in manifest,'GitHub/source runtime identity manifest must be pinned to 9.0.57')
...
for prop in (
    ...
    req(prop in props, f'missing v9.0.57 PostgreSQL/Hikari stability setting: {prop}')
print('PASS: DSE ERP 9.0.57 Quotation Source + linked Sale + runtime stability contract')
