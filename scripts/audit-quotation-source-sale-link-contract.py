...
req("runtime identity manifest phase must be 9.0.62" in pdf_audit and 'runtime.phase=9.0.62' in manifest,'GitHub/source runtime identity manifest must be pinned to 9.0.62')
...
print('QUOTATION_SOURCE_SALE_LINK_CONTRACT_OK version=9.0.62')
