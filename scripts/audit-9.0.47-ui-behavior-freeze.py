#!/usr/bin/env python3
"""DSE ERP 9.0.47 reviewed UI / behavior preservation audit.

The baseline freezes the currently approved 9.0.47 IntelliJ source after each
...
BASELINE = ROOT / "scripts" / "ui-behavior-freeze-9.0.47.json"
...
def capture() -> dict:
    ...
    return {
        "contract": "DSE ERP 9.0.47 approved UI/behavior freeze",
        "version": "9.0.47",
