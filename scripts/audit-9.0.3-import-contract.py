...
require('APP_VERSION = "9.0.47"' in runtime and 'BUILD_REVISION = "9.0.47"' in runtime,
        'Desktop APP_VERSION and BUILD_REVISION must both be 9.0.18')
require('dse.app.version=9.0.47' in server_props and 'dse.build.revision=9.0.47' in server_props,
