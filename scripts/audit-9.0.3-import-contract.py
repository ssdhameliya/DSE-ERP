...
require('APP_VERSION = "9.0.37"' in runtime and 'BUILD_REVISION = "9.0.37"' in runtime,
        'Desktop APP_VERSION and BUILD_REVISION must both be 9.0.18')
require('dse.app.version=9.0.37' in server_props and 'dse.build.revision=9.0.37' in server_props,
