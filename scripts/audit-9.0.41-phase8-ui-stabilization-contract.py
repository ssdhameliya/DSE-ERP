#!/usr/bin/env python3
"""DSE ERP 9.0.41 corrective UI stabilization contract.
...
if 'fx:id="metricPane"' not in viewer_raw or 'report-metric-strip,erp-kpi-section' not in viewer_raw:
    fail("Report Viewer metric strip is not enrolled in the responsive KPI engine")
