#!/usr/bin/env python3
"""DSE ERP 9.0.49 financial integrity and multi-user hardening contract."""
...
for token in (
    ...
    need(token in migration, f"9.0.49 migration missing: {token}")
need("V9_0_47__financial_multi_user_hardening" in runner, "9.0.49 migration is not registered at startup")
