...
req('QSRC_MIG_' in newmig,'v9.0.28 must bridge historical Source values to the canonical Master once')
...
print('PASS: v9.0.19 data compatibility retained; runtime superseded by v9.0.28 generic Master path')
