...
req('QSRC_MIG_' in newmig,'v9.0.34 must bridge historical Source values to the canonical Master once')
...
print('PASS: v9.0.19 data compatibility retained; runtime superseded by v9.0.34 generic Master path')
