...
for t in ['registration_request','totp_secret_enc','approval_status']: need(t in mig,'migration missing '+t)
fxml=read('desktop/src/main/resources/fxml/pages/Registration.fxml')
for t in ['CAPTCHA','Google / Microsoft Authenticator','Submit for Admin Approval']: need(t in fxml,'registration UI missing '+t)
need((r/'desktop/src/main/resources/fxml/pages/RegistrationApprovals.fxml').exists(),'approval screen missing')
print('PASS: 9.0.50 registration security contract')
