...
require('BUILD_REVISION = "9.0.32"' in runtime_contract and 'APP_VERSION = "9.0.32"' in runtime_contract, '9.0.18 must publish one exact desktop/server version/build contract so stale backends are rejected')
