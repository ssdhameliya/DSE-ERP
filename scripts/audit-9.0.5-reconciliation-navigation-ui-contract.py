...
require('APP_VERSION = "9.0.46"' in runtime and 'BUILD_REVISION = "9.0.46"' in runtime,
        'Desktop app/build identity must both be current 9.0.18')
require('dse.app.version=9.0.46' in server_props and 'dse.build.revision=9.0.46' in server_props,
