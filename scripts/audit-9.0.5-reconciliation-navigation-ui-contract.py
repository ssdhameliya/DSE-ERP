...
require('fx:id="statementWorkspace"' in bank_fxml and 'fx:id="statementHistoryDrawer" prefWidth="720" minWidth="620" maxWidth="850"' in bank_fxml,
...
require('APP_VERSION = "9.0.5"' in runtime and 'BUILD_REVISION = "9.0.5"' in runtime,
        'Desktop app/build identity must both be 9.0.5')
require('dse.app.version=9.0.5' in server_props and 'dse.build.revision=9.0.5' in server_props,
        'Spring Boot app/build identity must exactly match desktop 9.0.5')
