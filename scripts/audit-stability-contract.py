...
# Release identity
need('<version>9.0.74</version>' in text('pom.xml') and '<dse.phase>9.0.74</dse.phase>' in text('pom.xml'),'root identity')
need('APP_VERSION = "9.0.74"' in text('shared/src/main/java/org/example/shared/RuntimeContract.java'),'shared identity')
need('dse.app.version=9.0.74' in text('server/src/main/resources/application.properties'),'server identity')
need('version=9.0.74' in text('desktop/src/main/resources/app-version.properties'),'desktop identity')
# Workspace recovery
...
need('V9_0_63__workspace_master_email_stability' in runner,'9.0.74 migration not registered')
