...
# Release identity
need('<version>9.0.79</version>' in text('pom.xml') and '<dse.phase>9.0.79</dse.phase>' in text('pom.xml'),'root identity')
need('APP_VERSION = "9.0.79"' in text('shared/src/main/java/org/example/shared/RuntimeContract.java'),'shared identity')
need('dse.app.version=9.0.79' in text('server/src/main/resources/application.properties'),'server identity')
need('version=9.0.79' in text('desktop/src/main/resources/app-version.properties'),'desktop identity')
# Workspace recovery
