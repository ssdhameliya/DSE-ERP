...
# Release identity.
req('APP_VERSION = "9.0.46"' in runtime and 'BUILD_REVISION = "9.0.46"' in runtime,'Runtime identity must be 9.0.18')
req('dse.app.version=9.0.46' in props and 'dse.build.revision=9.0.46' in props,'Server identity must be 9.0.18')
req('<version>9.0.46</version>' in pom and '<dse.phase>9.0.46</dse.phase>' in pom,'Maven identity must be 9.0.18')
req('version=9.0.46' in app and 'DEFAULT_VERSION="9.0.46"' in update,'Desktop/update identity must be 9.0.18')
