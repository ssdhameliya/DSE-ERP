...
req('<version>9.0.41</version>' in pom and '<dse.phase>9.0.41</dse.phase>' in pom,'Maven identity must be 9.0.18')
req('version=9.0.41' in app and 'DEFAULT_VERSION="9.0.41"' in update,'Desktop/update identity must be 9.0.18')
