...
req("QUOTATION_SOURCE" in mig and 'item_description_snapshot' in mig,'v9.0.17 migration must seed source master and snapshot historical descriptions')
req('V9_0_14__quotation_register_hardening' in runner,'runtime migration runner must register v9.0.17 migration')
...
print('PASS: DSE ERP 9.0.17 quotation/register/import/edit-preservation contract')
