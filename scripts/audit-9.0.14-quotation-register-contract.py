...
req('<version>9.0.32</version>' in pom and '<dse.phase>9.0.32</dse.phase>' in pom,'Maven identity must be 9.0.18')
req('version=9.0.32' in app and 'DEFAULT_VERSION="9.0.32"' in update,'Desktop/update identity must be 9.0.18')
