...
req("QUOTATION_SOURCE" in mig and 'item_description_snapshot' in mig,'v9.0.18 migration must seed source master and snapshot historical descriptions')
req('V9_0_14__quotation_register_hardening' in runner,'runtime migration runner must register v9.0.18 migration')
...
# Release identity.
req('APP_VERSION = "9.0.52"' in runtime and 'BUILD_REVISION = "9.0.52"' in runtime,'Runtime identity must be 9.0.18')
req('dse.app.version=9.0.52' in props and 'dse.build.revision=9.0.52' in props,'Server identity must be 9.0.18')
req('<version>9.0.52</version>' in pom and '<dse.phase>9.0.52</dse.phase>' in pom,'Maven identity must be 9.0.18')
req('version=9.0.52' in app and 'DEFAULT_VERSION="9.0.52"' in update,'Desktop/update identity must be 9.0.18')
...
print('PASS: DSE ERP 9.0.18 quotation/register/import/edit-preservation contract')
