...
req('<version>9.0.28</version>' in pom and '<dse.phase>9.0.28</dse.phase>' in pom,'Maven identity must be 9.0.18')
req('version=9.0.28' in app and 'DEFAULT_VERSION="9.0.28"' in update,'Desktop/update identity must be 9.0.18')
