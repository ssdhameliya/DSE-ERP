#!/usr/bin/env python3
"""DSE ERP 9.0.47 corrective UI stabilization contract.
...
if 'fx:id="metricPane"' in viewer_raw or 'report-metric-strip' in viewer_raw:
    fail("Individual Report Viewer KPI strip must remain removed in 9.0.47")
...
# 9.0.47 table-first Reporting / icon+text / Bank KPI contracts.
