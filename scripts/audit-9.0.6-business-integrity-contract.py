...
req('APP_VERSION = "9.0.40"' in runtime and 'BUILD_REVISION = "9.0.40"' in runtime,'desktop version/build must both be 9.0.18')
req('dse.app.version=9.0.40' in props and 'dse.build.revision=9.0.40' in props,'server version/build must both be 9.0.18')
