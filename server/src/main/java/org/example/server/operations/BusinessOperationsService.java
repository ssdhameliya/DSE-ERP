...
public class BusinessOperationsService {
 ...
 @Transactional(readOnly=true) public String nextPurchaseInvoice(){return formattedNext("PURCHASE_INVOICE_FORMAT","PUR/DD-MM-YYYY/XXXX",purchases.findAll().stream().map(PurchaseHeaderEntity::getInvoiceNo).filter(Objects::nonNull).toList());}
