...
public class PurchaseReconEntity {
 ...
 @Version @Column(name="row_version",nullable=false) private Long rowVersion=0L;
    ...
    @Column(name="source_row") private Integer sourceRow; private String notes; @Column(name="attachment_path") private String attachmentPath;
