    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http, BearerTokenAuthenticationFilter bearerFilter)
        ...
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers("/api/runtime/health", "/api/auth/health", "/api/auth/login", "/api/setup/bootstrap").permitAll()
                        .requestMatchers("/api/admin/**", "/api/auth/register", "/api/auth/registration-roles", "/api/auth/lookup").hasRole("ADMIN")
