    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http, BearerTokenAuthenticationFilter bearerFilter)
        ...
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers("/error", "/api/runtime/health", "/api/updates/**", "/api/auth/health", "/api/auth/login", "/api/auth/login/mfa/enrollment", "/api/auth/login/mfa/complete", "/api/auth/login/mfa/resend", "/api/auth/login/mfa/recovery/request", "/api/auth/login/mfa/recovery/complete", "/api/setup/bootstrap", "/api/setup/status",
