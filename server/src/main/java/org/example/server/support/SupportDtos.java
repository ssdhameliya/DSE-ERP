...
public final class SupportDtos { private SupportDtos(){}
 ...
 public record PaymentRow(int id,String date,String reference,String mode,double amount,String notes,String receivedFrom,String attachment,String paymentType){}
