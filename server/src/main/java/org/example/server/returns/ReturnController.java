...
public class ReturnController {
    ...
    @GetMapping("/settlements") public List<ReturnDtos.Settlement> settlements(@RequestParam String type){service.requireTypeAccess(type);return service.settlements(type);}
