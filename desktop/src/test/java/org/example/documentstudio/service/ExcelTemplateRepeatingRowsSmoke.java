...
public final class ExcelTemplateRepeatingRowsSmoke {
    ...
    public static void main(String[] args) throws Exception {
        ...
        staleSampleRowFormattingIsNormalizedToTemplateRow();
    ...
    private static void staleSampleRowFormattingIsNormalizedToTemplateRow() throws Exception {
        try (Workbook workbook = new XSSFWorkbook()) {
            Sheet sheet = workbook.createSheet("Invoice");
            ...
            ExcelTemplateRenderer.fillWorkbook(workbook, data(), List.of());
            if (sheet.getRow(0).getCell(0).getCellStyle().getIndex() != sheet.getRow(1).getCell(0).getCellStyle().getIndex())
                throw new AssertionError("Generated item row retained stale red/pink sample formatting");
        }
    }
