...
public class Customer360Controller {
    ...
    @FXML public void initialize(){
        ...
        if(customer==null||customer.getId()<=0){AppDialogService.warning(tabs,"Customer 360°","No customer selected","Open Customer 360° from the Customers register.");backToCustomers();return;}
    ...
    private void showError(Throwable e){AppDialogService.error(tabs,"Customer 360°","Operation could not be completed",e==null?"Unexpected error":safe(e.getMessage()));}
