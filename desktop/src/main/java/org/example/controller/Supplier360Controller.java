...
public final class Supplier360Controller {
    ...
    @FXML public void initialize(){
        ...
        if(supplier==null||supplier.getId()<=0){ModernDialog.warning(tabs,"Supplier 360°","No supplier selected","Open Supplier 360° from the Suppliers register.");backToSuppliers();return;}
    ...
    private void showError(Throwable e){ModernDialog.error(tabs,"Supplier 360°","Operation could not be completed",e==null?"Unexpected error":safe(e.getMessage()));}
