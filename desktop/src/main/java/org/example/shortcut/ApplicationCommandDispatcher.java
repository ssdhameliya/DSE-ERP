...
public final class ApplicationCommandDispatcher {
    ...
    private static Spec spec(Action a){return switch(a){
        ...
        case NEW_CURRENT->new Spec("New",List.of("New","Add New","Create New","New Sale","New Purchase","New Item","Add Customer","Add Supplier"),List.of("newEntry","createNew","addNew","createSale","createPurchase","add"));
