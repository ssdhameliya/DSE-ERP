...
public final class TemplateFieldCatalog {
    ...
    private static final List<TemplateFieldDefinition> SALES = List.of(
            ...
            text("sales.referenceNo", "Reference Number", "Sales"),
    ...
    private static final List<TemplateFieldDefinition> SALES_JSON = List.of(
            ...
            text("party.stateCode", "State Code", "Party (Customer)"),
            text("party.placeOfSupply", "Place of Supply", "Party (Customer)"),
            ...
            text("tax.primaryLabel", "Tax Row 1 Label (CGST or IGST - automatic)", "Tax"),
            text("tax.primaryAmount", "Tax Row 1 Amount (CGST or IGST - automatic)", "Tax"),
            text("tax.secondaryLabel", "Tax Row 2 Label (SGST when applicable)", "Tax"),
            text("tax.secondaryAmount", "Tax Row 2 Amount (SGST when applicable)", "Tax"),
    ...
    private static final List<TemplateFieldDefinition> UNIVERSAL_JSON = List.of(
            ...
            text("party.stateCode", "State Code", "JSON • Party"),
            text("party.placeOfSupply", "Place of Supply", "JSON • Party"),
            ...
            text("tax.primaryLabel", "Tax Row 1 Label (CGST or IGST - automatic)", "JSON • Tax"),
            text("tax.primaryAmount", "Tax Row 1 Amount (CGST or IGST - automatic)", "JSON • Tax"),
            text("tax.secondaryLabel", "Tax Row 2 Label (SGST when applicable)", "JSON • Tax"),
            text("tax.secondaryAmount", "Tax Row 2 Amount (SGST when applicable)", "JSON • Tax"),
    ...
    private static final List<TemplateFieldDefinition> SALES_EXCEL_EXTRA = List.of(
            ...
            text("sales.orderNo", "Customer PO Number", "Sales"),
