...
import javafx.application.Platform;import javafx.scene.control.*;import org.example.config.ConfigManager;import java.time.Instant;import java.util.concurrent.atomic.AtomicReference;
...
public final class RuntimeConnectionState{
 ...
 private static void show(String title,String text,Alert.AlertType type){Platform.runLater(()->{Alert a=new Alert(type,text,ButtonType.OK);a.setTitle(title);a.setHeaderText(title);a.show();});}
}
